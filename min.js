! function() {
    ...
    fetch(`https://us-central1-recipes-generator.cloudfunctions.net/getCardData?id=${e}&cardid=${i}`).then(t => t.json()).then(t => {
        ...
        let i = function() {
            ...
            video = function(){
                let t = a.video.contentUrl;
                return r.video = t, t ? '<divstyle="height: 0px; left: 0px; overflow: hidden; padding-bottom: 56.3%; position: relative; width: 100%; margin-bottom: 20px;"><iframeallow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"allowfullscreen=""class="BLOG_video_class"frameborder="0"height="266"src="https://www.youtube.com/embed/W-Zna734nBQ?autoplay=1&mute=1"style="height: 100%; left: 0px; min-width: 100%; position: absolute; top: 0px; width: 100%; width: 1px;"width="320"youtube-src-id="W-Zna734nBQ"></iframe></div>'
