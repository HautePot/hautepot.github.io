! function() {
    ...
    fetch(`https://us-central1-recipes-generator.cloudfunctions.net/getCardData?id=${e}&cardid=${i}`).then(t => t.json()).then(t => {
        ...
        let w = function() {
            ...
            E = [];
        E[0] = S + i + k + F + e + W + "</div>" + l + m + L + P + T + I + N + H + b + y + w + x + $ + A, E[1] = S + i + k + F + e + W + "</div>" + l + m + L + P + T + I + N + H + b + y + w + x + $ + A, E[2] = S + e + F + i + k + W + "</div>" + l + m + L + P + T + I + N + H + b + y + w + x + $ + A, E[3] = S + i + k + F + e + W + "</div>" + l + m + L + P + T + I + N + H + b + y + w + x + $ + A, E[4] = S + w + x + $ + k + W + F + "</div><div class='ccm-flex-b'>" + i + "<div class='ccm-info-wrapper'>" + e + m + "</div></div>" + l + L + P + T + I + N + H + b + y + A, E[5] = S + w + x + $ + k + W + F + "</div>" + video + i + e + m + l + L + P + T + I + N + H + b + y + A, E[6] = S + w + x + $ + k + W + F + "</div>" + video i + e + l + m + L + P + T + I + N + H + b + y + A;
